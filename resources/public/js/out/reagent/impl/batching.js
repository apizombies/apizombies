...
var or__4567__auto__ = (w["requestAnimationFrame"]);
if(cljs.core.truth_(or__4567__auto__)){
return or__4567__auto__;
} else {
var or__4567__auto____$1 = (w["webkitRequestAnimationFrame"]);
if(cljs.core.truth_(or__4567__auto____$1)){
return or__4567__auto____$1;
} else {
var or__4567__auto____$2 = (w["mozRequestAnimationFrame"]);
if(cljs.core.truth_(or__4567__auto____$2)){
return or__4567__auto____$2;
} else {
var or__4567__auto____$3 = (w["msRequestAnimationFrame"]);
if(cljs.core.truth_(or__4567__auto____$3)){
return or__4567__auto____$3;
} else {
...
var n__5470__auto__ = a.length;
var i = (0);
while(true){
if((i < n__5470__auto__)){
var c_10792 = (a[i]);
if(cljs.core.truth_((c_10792["cljsIsDirty"]))){
(c_10792["forceUpdate"])();
} else {
}
...
reagent.impl.batching.RenderQueue.cljs$lang$ctorPrWriter = (function (this__5165__auto__,writer__5166__auto__,opt__5167__auto__){
return cljs.core._write.call(null,writer__5166__auto__,"reagent.impl.batching/RenderQueue");
});
...
var G__10796 = c;
var G__10796__$1 = (((G__10796 == null))?null:(G__10796["props"]));
var G__10796__$2 = (((G__10796__$1 == null))?null:(G__10796__$1["argv"]));
return G__10796__$2;
});
...
var G__10798_10799 = (c["cljsRatom"]);
var G__10798_10800__$1 = (((G__10798_10799 == null))?null:reagent.ratom.dispose_BANG_.call(null,G__10798_10799));
