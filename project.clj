(defproject apizombies "0.1.0-SNAPSHOT"
  ...
  :clean-targets ^{:protect false} [:target-path
                                    ...
                                    [:cljsbuild :builds :test :compiler :source-map]
                                    [:cljsbuild :builds :test :compiler :output-to]
                                    [:cljsbuild :builds :app :compiler :output-dir]
                                    [:cljsbuild :builds :app :compiler :source-map]
  ...
  :profiles {:dev {:source-paths ["env/dev/clj"]
                   ...
                   :repl-options {:init-ns apizombies.server
                   ...
                   :figwheel {:http-server-root "public"
                              ...
                              :ring-handler apizombies.server/http-handler}
