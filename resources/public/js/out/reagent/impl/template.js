...
reagent.impl.template.NativeWrapper.cljs$lang$ctorPrWriter = (function (this__5165__auto__,writer__5166__auto__,opt__5167__auto__){
return cljs.core._write.call(null,writer__5166__auto__,"reagent.impl.template/NativeWrapper");
});
...
var or__4567__auto__ = reagent.impl.template.named_QMARK_.call(null,x);
...
var or__4567__auto__ = reagent.impl.template.hiccup_tag_QMARK_.call(null,x);
if(cljs.core.truth_(or__4567__auto__)){
return or__4567__auto__;
} else {
...
var G__10804 = o;
(G__10804[reagent.impl.template.cached_prop_name.call(null,k)] = reagent$impl$template$convert_prop_value.call(null,v));
...
var G__10806__i = 0, G__10806__a = new Array(arguments.length -  0);
while (G__10806__i < G__10806__a.length) {G__10806__a[G__10806__i] = arguments[G__10806__i + 0]; ++G__10806__i;}
  args = new cljs.core.IndexedSeq(G__10806__a,0);
} 
return G__10805__delegate.call(this,args);};
G__10805.cljs$lang$maxFixedArity = 0;
G__10805.cljs$lang$applyTo = (function (arglist__10807){
...
var old_10808 = (p["className"]);
(p["className"] = ((cljs.core.some_QMARK_.call(null,old_10808))?[cljs.core.str(class$),cljs.core.str(" "),cljs.core.str(old_10808)].join(''):class$));
} else {
}
...
if(cljs.core.not.call(null,(function (){var and__4555__auto__ = (node === document.activeElement);
if(and__4555__auto__){
var and__4555__auto____$1 = reagent.impl.template.has_selection_api_QMARK_.call(null,(node["type"]));
...
if(cljs.core.truth_((function (){var and__4555__auto__ = (jsprops["hasOwnProperty"])("onChange");
...
var G__10811 = jsprops;
(G__10811["defaultValue"] = value);

(G__10811["onChange"] = ((function (G__10811,v,value,on_change){
return (function (p1__10809_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__10809_SHARP_);
});})(G__10811,v,value,on_change))
);
...
var vec__10813 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__10813,(0),null);
var id = cljs.core.nth.call(null,vec__10813,(1),null);
var class$ = cljs.core.nth.call(null,vec__10813,(2),null);
...
var temp__4427__auto__ = (function (){var G__10817 = cljs.core.meta.call(null,v);
var G__10817__$1 = (((G__10817 == null))?null:reagent.impl.template.get_key.call(null,G__10817));
return G__10817__$1;
})();
if((temp__4427__auto__ == null)){
...
var jsprops = {"argv": v};
var G__10819_10820 = v;
var G__10819_10821__$1 = (((G__10819_10820 == null))?null:reagent.impl.template.key_from_vec.call(null,G__10819_10820));
var G__10819_10822__$2 = (((G__10819_10821__$1 == null))?null:(jsprops["key"] = G__10819_10821__$1));
...
var p = (function (){var temp__4427__auto__ = (function (){var G__10825 = cljs.core.meta.call(null,argv);
var G__10825__$1 = (((G__10825 == null))?null:reagent.impl.template.get_key.call(null,G__10825));
return G__10825__$1;
})();
if((temp__4427__auto__ == null)){
return jsprops;
...
var G__10826 = (((jsprops == null))?{}:jsprops);
(G__10826["key"] = key);
...
var G__10827 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,v,(0),cljs.core.subs.call(null,n,(pos + (1))))], null);
v = G__10827;
continue;
}
} else {
...
var n__5470__auto___10828 = a.length;
var i_10829 = (0);
while(true){
if((i_10829 < n__5470__auto___10828)){
(a[i_10829] = reagent.impl.template.as_element.call(null,(a[i_10829])));

var G__10830 = (i_10829 + (1));
i_10829 = G__10830;
continue;
} else {
}
...
var a = cljs.core.into_array.call(null,s);
var n__5470__auto___10831 = a.length;
var i_10832 = (0);
while(true){
if((i_10832 < n__5470__auto___10831)){
var val_10833 = (a[i_10832]);
if((cljs.core.vector_QMARK_.call(null,val_10833)) && ((reagent.impl.template.key_from_vec.call(null,val_10833) == null))){
(o["no-key"] = true);
} else {
}

(a[i_10832] = reagent.impl.template.as_element.call(null,val_10833));

var G__10834 = (i_10832 + (1));
i_10832 = G__10834;
continue;
} else {
}
...
if(cljs.core.truth_((function (){var and__4555__auto__ = cljs.core.not.call(null,reagent.impl.component._STAR_non_reactive_STAR_);
if(and__4555__auto__){
return (ctx["no-key"]);
} else {
return and__4555__auto__;
...
var G__10836 = (cljs.core.count.call(null,argv) - first_child);
switch (G__10836) {
case (0):
...
break;
default:
return (React["createElement"]).apply(null,cljs.core.reduce_kv.call(null,((function (G__10836){
